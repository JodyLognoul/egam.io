...
{{ Form::model(Auth::user(),array('method' => 'PUT','route' => array('user.update',Auth::user()->id),'class' => 'form-profile form-horizontal profile', 'role' => 'form')) }}
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3>Profile <small>- Parties</small></h3>
		</div>
