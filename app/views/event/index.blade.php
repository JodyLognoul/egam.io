...
<div class="event-index">
	...
	<script class="active-filters-script" type="text/template">
		...
		<span class="badge badge-@{{ buttonClass }} pull-right">
			@{{ qty }}
			event
			@{{#if author}}
				<span>s</span>
	...
	<div class="thumbnail">
		<div id="carousel-generic@{{id}}" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active"><img src="{{ URL::asset('images/got.jpg') }}" alt="@{{ title }}" class="img-responsive"></div>
				<div class="item"><img src="{{ URL::asset('images/carcassonne.jpg') }}" alt="@{{ title }}" class="img-responsive"></div>
				<div class="item"><img src="{{ URL::asset('images/elixir.jpg') }}" alt="@{{ title }}" class="img-responsive"></div>
			</div>
