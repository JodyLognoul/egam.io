<!-- Modal -->
<div class="modal-modify-user modal-ind modal fade" id="modal-modify-title" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group has-feedback">
                    {{ Form::text('title', Input::old('title'), array('class' => 'form-control','placeholder' => 'My beautiful event ...','autofocus' => "")) }}
                    <span class="text-danger text-input-error">{{ $errors->first('title') }}</span>
