...
class EventTableSeeder extends Seeder {
	...
	public function run()
	{
		Event::create(array(
			...
			'event_datetime' 	=> '2014-05-10 20:30',
			'max_places' 	=> '14', 
			'current_place' => '7',
			'address_id' 	=> '1'));
		Event::create(array(
			...
			'event_datetime' 	=> '2014-05-11 20:30',
			'max_places' 	=> '8', 
			'current_place' => '2',
			'address_id' 	=> '2'));
		Event::create(array(
			...
			'event_datetime' 	=> '2014-05-12 20:30',
			'max_places' 	=> '18', 
			'current_place' => '2',
			'address_id' 	=> '3'));
		Event::create(array(
			...
			'event_datetime' 	=> '2014-05-13 20:30',
			'max_places' 	=> '5', 
			'current_place' => '2',
			'address_id' 	=> '3'));
		Event::create(array(
			...
			'event_datetime' 	=> '2014-05-14 20:30',
			'max_places' 	=> '9', 
			'current_place' => '2',
			'address_id' 	=> '3'));
		Event::create(array(
			...
			'event_datetime' 	=> '2014-05-15 20:30',
			'max_places' 	=> '3', 
			'current_place' => '2',
			'address_id' 	=> '3'));
		Event::create(array(
			...
			'event_datetime' 	=> '2014-05-16 20:30',
			'max_places' 	=> '11', 
			'current_place' => '2',
			'address_id' 	=> '4'));
	}
